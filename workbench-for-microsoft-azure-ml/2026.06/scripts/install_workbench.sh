...
echo "$d Fetching Posit Workbench 2026.06.0+242.pro13 $d"
# For non-development versions, download the deb package using apt-get
apt-get download "${package_name}=2026.06.0+242.pro13"
...
# Install Workbench
echo "$d Install Posit Workbench 2026.06.0+242.pro13 $d"
